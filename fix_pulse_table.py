...
replacement = '''<div class="case-study-container">
        ...
        <div class="cs-meta" style="grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));">
            <div class="meta-item">
                <h4>Role</h4>
                <p>Product Design &bull; UX Strategy &bull; UI/UX &bull; Prototyping</p>
            </div>
            <div class="meta-item">
                <h4>Platform</h4>
                <p>Web Application</p>
        ...
        <div class="cs-section">
            ...
            <h3>01. Make the day immediately visible</h3>
            ...
            <h3>02. Connect clinical and operational workflows</h3>
            ...
            <h3>03. Keep actions close to context</h3>
        ...
        <div class="cs-section">
            ...
            <h3>02. Move naturally into patient care</h3>
            ...
            <h3>04. Design the system, not isolated screens</h3>
        ...
        <div class="cs-section">
            ...
            <h3>01. Balancing depth with simplicity</h3>
            ...
            <h3>02. Preserving clinical context</h3>
            ...
            <h3>03. Building trust into the experience</h3>
            ...
            <table class="cs-table">
                ...
                <tbody>
                    <tr>
                        <td><strong>Feature depth vs simplicity</strong></td>
                        <td>Group workflows into focused modules</td>
                    </tr>
                    <tr>
                        <td><strong>Speed vs security</strong></td>
                        <td>Keep security controls accessible without disrupting daily tasks</td>
                    </tr>
                    <tr>
                        <td><strong>Flexibility vs consistency</strong></td>
                        <td>Reuse patterns across scheduling, patients, billing, and records</td>
                    </tr>
                    <tr>
                        <td><strong>Information density vs clarity</strong></td>
                        <td>Prioritise hierarchy, summaries, filters, and progressive detail</td>
                    </tr>
                </tbody>
            </table>
...
new_html = re.sub(r'<div class="case-study-container">.*?</div>\s*(<!-- NAV|</div>|</body>|<script)', replacement + r'\n\n    \1', html, flags=re.DOTALL)
