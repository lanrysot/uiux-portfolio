...
# Replace the inner body of case-study-container
# The container has <div class="case-study-container"> ... </div>
# Let's just use regex to replace everything from <h1 class="cs-title"> to the end of case-study-container.
...
html = re.sub(r'<h1 class="cs-title">.*?(?=</section>|</div>\s*<footer)', replacement + '</div>', html, flags=re.DOTALL)
